    ...
    <div className="App">
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container px-4 px-lg-5">
                <a className="navbar-brand" href="#!">Hungry Hungry</a>
        ...
        <header className="bg-dark py-5  banner">
            <div className="container px-4 px-lg-5 my-5">
                <div className="text-center text-white">
                    <h1 className="display-4 fw-bolder fonts-style-1">Hungry Hungry</h1>
                    <p className="lead fw-normal text-white-50 mb-0 fonts-style-2">Good food is a good mood</p>
                </div>
            </div>
        </header>
        {/* <!-- Section--> */}
                ...
                <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div className="col mb-5">
                        <div className="card h-100">
                            <div className="badge bg-dark text-white position-absolute a2">Sale</div>
                            {/* <!-- Product image--> */}
                    ...
                    <div className="col mb-5">
                        <div className="card h-100">
                            {/* <!-- Sale badge--> */}
                            <div className="badge bg-dark text-white position-absolute a1">Sale</div>
                            {/* <!-- Product image--> */}
                    ...
                    <div className="col mb-5">
                        <div className="card h-100">
                            {/* <!-- Sale badge--> */}
                            <div className="badge bg-dark text-white position-absolute a3">Sale</div>
                            {/* <!-- Product image--> */}
                    ...
                    <div className="col mb-5">
                        <div className="card h-100">
                            {/* <!-- Sale badge--> */}
                            <div className="badge bg-dark text-white position-absolute a4">Sale</div>
                            {/* <!-- Product image--> */}
        ...
        <footer className="py-5 bg-dark">
            <div className="container"><p className="m-0 text-center text-white">Copyright &copy; hungryhungry@gmail.com 2023</p></div>
        </footer>
